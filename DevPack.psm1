...
function Get-DynamicParam
{
    ...
    #
    # Create the dictionary, collection of attributes and set the parameters' attributes
    $RuntimeParameterDictionary = New-Object System.Management.Automation.RuntimeDefinedParameterDictionary
    $AttributeCollection = New-Object System.Collections.ObjectModel.Collection[System.Attribute]
    $ParameterAttribute = New-Object System.Management.Automation.ParameterAttribute
    $ParameterAttribute.Position = $Position
    $ParameterAttribute.Mandatory = $Required
    $AttributeCollection.Add($ParameterAttribute)

    ### Return the dynamic parameter
    #
    # Set the ValidateSet, add the ValidateSet to the attributes collection and create dynamic parameter
